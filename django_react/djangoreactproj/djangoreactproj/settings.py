"""
Django settings for djangoreactproj project.
...
SECRET_KEY = "django-insecure-fbt7#*!(hq#7!!sez_c&hq@f%ai2*ic*cz$f+rsldpx+w15#s&"
...
ROOT_URLCONF = "djangoreactproj.urls"
...
WSGI_APPLICATION = "djangoreactproj.wsgi.application"
